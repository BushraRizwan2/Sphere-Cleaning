...
const SchoolAndEducationalFacilityCleaningPage: React.FC<PageProps> = ({ service, phoneNumber, allServices }) => {
...
export default SchoolAndEducationalFacilityCleaningPage;
